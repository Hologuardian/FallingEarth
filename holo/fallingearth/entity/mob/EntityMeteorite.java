...
public class EntityMeteorite extends EntityMob implements IRangedAttackMob
{
	    ...
	    public EntityMeteorite(World par1World)
	    {
            ...
            this.tasks.addTask(4, new EntityAIArrowAttack(this, 0.25F, 20, 10, 6415.0F));
...
//	    }
		...
		@Override
		public void attackEntityWithRangedAttack(EntityLiving tar,
				float f) {
			EntitySmallFireball projectile = new EntitySmallFireball(this.worldObj, this, tar.posX, tar.posY, tar.posZ);
